...
SRC_URI = "file://oled/imx8mn_ssd1306.py \
           file://oled/imx8mn_stats.py \
           file://oled/__init__.py"
...
do_install () {
    ...
    install -p -m 644 oled/imx8mn_ssd1306.py ${D}${datadir}/oled/
    install -p -m 644 oled/imx8mn_stats.py ${D}${datadir}/oled/
    install -p -m 644 oled/__init__.py ${D}${datadir}/oled/
